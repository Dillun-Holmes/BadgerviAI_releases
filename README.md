...
```bash
pip install https://github.com/Dillun-Holmes/BadgerviAI_releases/releases/download/v4.3.1/badger_vision-4.3.1-py3-none-any.whl
```
...
```bash
pip install badger_vision-4.3.1-py3-none-any.whl
```
