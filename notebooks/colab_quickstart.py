#!/usr/bin/env python3
# -----------------------------------------------------------
# PhantomVision — Google Colab Quickstart (Python script)
#
...
# Clone repo if not present (needed for linux_train.py helpers)
...
# ── 3. Configuration ───────────────────────────────────────
# Set DATASET_PATH to your upload / Google Drive path, or leave
# as "" to use a synthetic demo dataset.
DATASET_PATH = ""  # e.g. "/content/my_dataset.7z" or "/content/drive/MyDrive/data/"
...
# ── 4. Prepare dataset ─────────────────────────────────────
ROOT = Path("/content/phantomvision_demo")
